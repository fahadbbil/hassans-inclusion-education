...
<!-- Mirrored from www.enar.ideal-theme.com/html5/blog-list.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 09 Oct 2020 18:23:28 GMT -->
<head>

	<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	
	<!-- Important stuff for SEO, don't neglect. (And don't dupicate values across your site!) -->
	<title>Blog List | Enar</title>
			...
			<div class="hm_blog_list clearfix">
				<div class="blog_grid_block clearfix">
					<div class="feature_inner">
						...
						<div class="feature_inner_corners">
							...
							<a href="images/blog/blog4.jpg" class="feature_inner_ling" data-rel="magnific-popup">
				...
				<div class="blog_grid_block clearfix">
					...
					<div class="blog_grid_con">
						...
						<p class="desc">Suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour.</p>
						<a class="btn_a" href="#">
							<span>
								<i class="in_left ico-angle-right"></i>
								<span>Details</span>
			...
			<div class="rows_container clearfix">
				<div class="col-md-3">
					<div class="footer_row">
						...
						<img alt="Enar" src="images/logo-light.png">
